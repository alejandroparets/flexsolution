          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-2">
              <Button size="lg" onClick={() => scrollTo("cita")} className="gap-2 text-base h-14 px-8 rounded-full" data-testid="hero-cta-cita">
                {t.ctaBooking} <ArrowRight size={18} />
              </Button>
